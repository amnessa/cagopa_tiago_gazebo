...
private:
    ...
    void send_goal()
    {
        ...
        // cago_reference1={2.679, 0.053, 1.501, 1.158, 0.000, 0.000, 0.000};  {-0.2838, 0.3931, -0.4173} left
        // cago_reference2={0.253, 0.053, -1.666, 1.327, 0.000, 0.000, 0.000}; {0.1079, -0.2806, -0.0677} right
        // cago_reference3={0.253, 1.021, -1.371, 1.539, 0.000, 0.000, 0.000};  {0.4721, -0.2519, -0.03935} top
        move2={-2.1301  , -1.2893  , -1.4276  , -0.5430 ,  -2.0135    ,     0, 0.000}; //0.1224,-0.2857,-0.06373 square starts here
        move3={-3.1334  , -0.3280  , -1.4276 ,  -1.3538  , -2.2904    ,     0 ,0.000}; //0.1224,-0.1224,-0.1377
        move4={ -1.7726 ,  -0.7231  , -1.1092 ,  -1.6360  , -1.9311   ,      0,0.000}; //0.2857,-0.1224,-0.1191
        move5={ -1.3853 ,  -1.3259  , -0.8222   ,-1.0958  , -1.6063      ,   0,0.000};//0.2857,-0.2857,-0.0452

...
private:
    ...
    void send_goal()
    {
        ...
        // cago_reference1={2.679, 0.053, 1.501, 1.158, 0.000, 0.000, 0.000};  {0.01256, 0.4747 0.159} left
        // cago_reference2={0.253, 0.053, -1.666, 1.327, 0.000, 0.000, 0.000}; {0.05778, -0.02788, -0.1997} right
        // cago_reference3={0.253, 1.021, -1.371, 1.539, 0.000, 0.000, 0.000};  {-0.1008, -0.06243, 0.07345} top
        move2={ -0.8046 ,   2.7079  ,  1.1632  , -2.2441   , 2.6830    ,     0, 0.000}; //-0.102,-0.06122,0.0764 square starts here
        move3={ 0.2055  ,  1.9221  , -0.4368 ,  -2.4438  ,  2.6931    ,     0 ,0.000}; //-0.102,0.02041,0.1211
        move4={ 0.1460  ,  2.8171  ,  0.6982  , -0.5330  ,  0.8384    ,     0,0.000}; //-0.02041,0.02041,-0.02923
